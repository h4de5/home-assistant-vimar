...
PLATFORMS = [DEVICE_TYPE_BINARY_SENSOR, DEVICE_TYPE_LIGHTS, DEVICE_TYPE_COVERS, DEVICE_TYPE_SWITCHES, DEVICE_TYPE_CLIMATES, DEVICE_TYPE_MEDIA_PLAYERS, DEVICE_TYPE_SCENES, DEVICE_TYPE_SENSORS]
